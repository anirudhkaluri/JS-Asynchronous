...
getTodos('./todos/todos.json',(err,data)=>{ //this is the callback function. it is called after getTodos is executed.
    console.log(data);
    getTodos('./todos/foods.json',(err,data)=>{
        console.log(data);
        getTodos('./todos/hobbies.json',(err,data)=>{
            console.log(data);
        });
    });
